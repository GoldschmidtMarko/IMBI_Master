...
def apply(logp,logm, parameters=None,sup= None, ratio = None, pruning_threshold = 0, size_par = None, cost_Variant = custom_enum.Cost_Variant.ACTIVITY_FREQUENCY_SCORE):
    """
    ...
    net, initial_marking, final_marking = tree_to_petri.apply(apply_tree(logp,logm, parameters,sup= sup, ratio = ratio, pruning_threshold = pruning_threshold, size_par = size_par, cost_Variant=cost_Variant))
...
def apply_tree(logp,logm, parameters=None, sup= None, ratio = None, pruning_threshold = 0, size_par = None, cost_Variant = custom_enum.Cost_Variant.ACTIVITY_FREQUENCY_SCORE):
    """
    ...
    sub = subtree.make_tree(logp,logm, dfgp, dfgp, dfgp, activitiesp, c, recursion_depth, 0.0, start_activitiesp,
                            end_activitiesp,
                            start_activitiesp, end_activitiesp, parameters, sup= sup, ratio = ratio, pruning_threshold = pruning_threshold, size_par = size_par, cost_Variant=cost_Variant)
