...
def generate_union_adjacency_matrices(matrix_P, nodeListP):
  # Find the common set of labels
  common_labels = ["start", "end"]
  common_labels = common_labels + list(set(nodeListP) - {"start", "end"})
  ...
  return common_labels, expanded_matrix1
...
def generate_data_from_log(logP, sup, ratio, size_par):
    ...
    unique_activity_count_P = get_activity_count_list_from_unique_list(activity_count_P, unique_node_P)
